...
export default function CommentActions({ post, handleLike, posts }) {
    ...
    return (
        <>
            <button className="flex items-center gap-2 text-gray hover:text-blue-400 transition-colors group">
            ...
            <button className="flex items-center gap-2 text-gray hover:text-green-400 transition-colors group">
            ...
            <button className={`flex items-center gap-2 text-gray hover:text-red-500 transition-colors group ${post.isLiked ? 'text-pink-500' : ''}`} onClick={onLikeClick}>
